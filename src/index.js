...
client.on('message', async (message) => {
    try {
        ...
        switch (command.name) {
            ...
            case 'players':
            case 'jogadores': await playersListCommand(message, command, client); break;
            case 'deleteplayer':
            case 'deletarplayer':
            case 'deletar player': await deletePlayerCommand(message, command, client); break;
            case 'codigoresgate':
            case 'codigo resgate':
            case 'códigoresgate':
            case 'código resgate': await codigoResgateCommand(message, command); break;
            ...
            case 'meuid':
            case 'meu id':
            case 'id': await meuIdCommand(message, command); break;
            case 'loja': await lojaCommand(message); break;
            case 'comprar': await comprarCommand(message, command); break;
            case 'inventario':
            case 'inventário': await inventarioCommand(message); break;
            ...
            case 'addpersonagem':
            case 'add personagem': await addPersonagemCommand(message, command); break;
            case 'rmvpersonagem':
            case 'removerpersonagem':
            case 'remover personagem': await rmvPersonagemCommand(message, command); break;
            case 'viajar': 
            case 'linkar': await viagemCommand(message, command, client); break;
            case 'trocarpersonagem':
            case 'trocar personagem': await trocarPersonagemCommand(message, command); break;
            ...
            case 'saldo':
            case 'poupanca': await saldoCommand(message, command, client); break;
            case 'retirarpoupanca':
            case 'retirar poupanca':
            case 'sacarpoupanca':
            case 'sacar poupanca': await retirarPoupancaCommand(message, command, client); break;
            case 'pix': await pixCommand(message, command, client); break;
            case 'extrato': await extratoCommand(message, command, client); break;
            case 'emprestimo':
            case 'empréstimo':
            case 'loan': await emprestimoCommand(message, command, client); break;
            case 'transferir': await message.reply('Esse comando mudou para */pix @pessoa valor*.'); break;
            case 'convite':
            case 'convites': await conviteCommand(message, command, client); break;
            case 'codes':
            case 'code': await codesCommand(message, command, client); break;
            case 'resgatar':
            case 'usarcode':
            case 'usar code': await resgatarCommand(message, command, client); break;
            case 'inspecionar':
            case 'inspect': await inspecionarCommand(message, command, client); break;
            case 'caixa':
            case 'caixas': await caixaCommand(message, command, client); break;
            case 'rankeada': await rankeadaCommand(message, command, client); break;
            case 'listarank':
            case 'lista rank':
            case 'ranklist': await listaRankCommand(message, command, client); break;
            case 'irank':
            case 'i rank': await iRankCommand(message, command, client); break;
            case 'desafio': await desafioCommand(message, command, client); break;
            case 'adesafio':
            case 'aceitardesafio':
            case 'aceitar desafio': await aceitarDesafioCommand(message, command, client); break;
            case 'rdesafio':
            case 'recusardesafio':
            case 'recusar desafio': await recusarDesafioCommand(message, command, client); break;
            case 'rv': await registrarVencedorRankedCommand(message, command, client); break;
            case 'removerrank':
            case 'remover rank': await removerRankCommand(message, command, client); break;
            case 'zmarket':
            case 'zloja': await zMarketCommand(message, command, client); break;
            case 'zbuy':
            case 'zcomprar': await zBuyCommand(message, command, client); break;
            case 'gerartorneio':
            case 'gerar torneio': await gerarTorneioCommand(message, command, client); break;
            case 'inscrever':
            case 'inscrevertorneio':
            case 'inscrever torneio': await inscreverTorneioCommand(message, command, client); break;
            case 'torneio':
            case 'torneios': await torneioCommand(message, command, client); break;
            case 'vencedor': await vencedorTorneioCommand(message, command, client); break;
            case 'eventos':
            case 'evento': await eventosCommand(message, command, client); break;
            case 'rankeventos':
            case 'rankingeventos': await rankEventosCommand(message, command, client); break;
            case 'rank':
            case 'ranking':
                ...
                break;
            case 'presenca':
            case 'presença': await presencaCommand(message, command, client); break;
            case 'cacacabeca':
            case 'cacacabeça': await bountyCommand(message, command, client); break;
            case 'caca':
                ...
                break;
            case 'vitoria':
            case 'vitória': await vitoriaCommand(message, command, client); break;
            case 'responder':
            case 'resposta': await responderCommand(message, command, client); break;
            case 'letra': await letraCommand(message, command, client); break;
            case 'chutar':
            case 'chute': await chutarCommand(message, command, client); break;
            case 'pegar': await pegarCommand(message, command, client); break;
            case 'tigrinho':
            case 'cassino':
            case 'cacaniquel':
            case 'caçaníquel': await tigrinhoCommand(message, command, client); break;
            case 'menu':
            case 'ajuda':
            case 'comandos': await helpCommand(message, command); break;
            case 'help': await message.reply('Esse comando mudou para */menu*.'); break;
            case 'blackjack':
            case 'bj': await blackjackCommand(message, command, client); break;
            case 'carta':
            case 'hit':
            case 'parar': await blackjackCommand(message, { ...command, argsText: command.name }, client); break;
            ...
            case 'pote':
            case 'allin':
            case 'sair': await pokerCommand(message, { ...command, argsText: command.name }, client); break;
            ...
            case 'ltruco':
            case 'limpotruco': await ltrucoCommand(message, command, client); break;
            case '3': case '6': case '9': case '12':
            case 'aceitar': case 'recusar': await trucoAnyCommand(message, { ...command, argsText: command.name }, client); break;
            case 'regras':
            case 'regra': await regrasCommand(message, command, client); break;
            default: break;
        }
    } catch (error) {
